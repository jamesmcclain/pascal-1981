...
_HOST_RUNTIME_NAMES = (
    ...
    'pas_readln_skip',
    'pas_write_fmt',
    'pas_enum_write_token',
    'pas_read_enum_name',
    'pas_fread_enum_name',
    'pabort',
    'pas_file_buffer',
    'pas_file_touch_buffer',
    'pas_file_reset',
    'pas_file_rewrite',
    'pas_file_get',
    'pas_file_put',
...
class TestZeroDeclareGuarantee(unittest.TestCase):
    ...
    def test_minimal_program_zero_declares(self):
        ...
        self.assertEqual(found, [], f'dead host-runtime declares in minimal program:\n{ir_text}')
    ...
    def test_minimal_module_zero_declares(self):
        ...
        found = [n for n in _declares(ir_text) if n in _HOST_RUNTIME_NAMES]
        self.assertEqual(found, [], f'dead host-runtime declares in minimal module:\n{ir_text}')
    ...
    def test_empty_unit_zero_declares(self):
        ...
        found = [n for n in _declares(ir_text) if n in _HOST_RUNTIME_NAMES]
        self.assertEqual(found, [], f'dead host-runtime declares in empty unit:\n{ir_text}')
    ...
    def test_unit_with_movel_emits_only_movel(self):
        ...
        self.assertEqual(runtime_declares, ['movel'], f'expected only movel; got {runtime_declares}')
