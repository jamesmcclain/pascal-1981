...
class TestManualKnownGaps(unittest.TestCase):
    ...
    def test_odd_accepts_word(self):
        ...
        # (Elementary Types, BOOLEAN, p.6-6).  ODD(WORD) is now accepted --
        # was a KNOWN CONFORMANCE GAP, tracked in docs/followups.md item 3,
        # fixed by special-casing ODD in type_checker.py.
